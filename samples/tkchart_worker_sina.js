...
importScripts("../jscommon/iyxchart.complier.js","../jscommon/iyxchart.js", "../jscommon/iyxchart.index.data.js","../jscommon/iyxchart.worker.js");

JSConsole.Complier.Log=()=>{ }

function JSSampleScriptWorker()
{
    this.newMethod=TKChartScriptWorker;   //派生
    this.newMethod();
    ...
    {
        var tkChartData={code:0, data:[] };
        tkChartData.symbol=tkChartData.name=data.Request.Data.symbol;
        ...
        for(var i=0;i<recv.length;++i)
        {
            ...
            tkChartData.data.push(newItem);

            yClose=close;
        }

       
        console.log("[JSSampleScriptWorker::RecvHistoryMinuteData] tkchartData ", tkChartData)
