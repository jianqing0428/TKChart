...
function JSPopMenu()
{
    ...
    this.CheckedClassName="IYXChart_MenuItem_Span_Checked  iconfont icon-checked";   //选中图标
    this.RightArrowClassName="IYXChart_MenuItem_Span_Arrow  iconfont icon-menu_arraw_right";  //右侧箭头
    this.SelectedClassName="IYXChart_MenuItem_Tr_Selected";
    ...
    this.AryTDClassName=
    [
        "IYXChart_MenuItem_Td_Status",      //图标
        "IYXChart_MenuItem_Td_Content",     //文字
        "IYXChart_MenuItem_Td_Shortcut",    //快捷方式
        "IYXChart_MenuItem_Td_Arrow"        //箭头
    ];
    ...
    this.CreatePopMenu=function(data)
    {
        ...
        root.className="IYXChart_PopMenu";

        var table=document.createElement("table");
        table.className="IYXChart_PopMenu_Table";
        root.appendChild(table);

        var tbody=document.createElement("tbody");
        tbody.className="IYXChart_PopMenu_Tbody";
    ...
    this.CreateMenu=function(parentItem, item)
    {
        ...
        trDom.className='IYXChart_MenuItem_Tr';

        if (item.Disable===true) trDom.classList.add('IYXChart_DrawTool_Disable_Tr');
        ...
        if (IFrameSplitOperator.IsNonEmptyArray(item.SubMenu)) //子菜单
        {
            ...
            subRoot.className="IYXChart_PopSubMenu";

            var subTable=document.createElement("table");
            subTable.className="IYXChart_PopMenu_Table";
            subRoot.appendChild(subTable);

            var subTbody=document.createElement("tbody");
            subTbody.className="IYXChart_PopMenu_TBody";
    ...
    this.CreateSeparatorTr=function()
    {
        ...
        trSeparator.className='IYXChart_MenuItem_Tr_Separator';

        var tdDom=document.createElement("td");
        tdDom.className="IYXChart_MenuItem_Td_Status_Separator";
        trSeparator.appendChild(tdDom);

        var tdDom=document.createElement("td");
        tdDom.className="IYXChart_MenuItem_Td_Separator";
        trSeparator.appendChild(tdDom);
