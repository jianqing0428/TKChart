...
function JSScrollBarChartContainer(uielement)
{
    ...
    this.CreateChartPaint=function(name)
    {
        ...
        chart.GetEventCallback=(id)=> { return this.GetEventCallback(id); }
        chart.GetTKChartCallback=()=>{ return this.GetTKChart(); }
    ...
    this.UpdateXDataOffset=function(obj)
    {
        ...
        if (this.TKChart && this.TKChart.JSChartContainer)
        {
            var internalChart=this.TKChart.JSChartContainer;
