...
function TKChartScriptWorker()
{
    ...
    {
        JSConsole.Complier.Log(`[TKChartScriptWorker::NetworkFilter] [${data.Name}][${data.Explain}] data=`, data);
        //数据下载
    }
    ...
    this.ExecuteScript=function(indexData, message)
    {
        ...
        JSConsole.Complier.Log('[TKChartScriptWorker::ExecuteScript] scriptObj=',scriptObj);
