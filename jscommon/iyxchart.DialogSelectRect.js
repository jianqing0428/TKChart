...
function JSDialogSelectRect()
{
    ...
    this.Create=function()
    {
        ...
        divDom.className='IYXChart_SelectRect_Dialog_Div';

        var divTitle=document.createElement("div");
        divTitle.className='IYXChart_SelectRect_Title_Div';
        divTitle.onmousedown=(e)=>{   this.OnMouseDownTitle(e);}

        var divName=document.createElement("div");
        divName.className='IYXChart_SelectRect_Name_Div';
        divName.innerText="区间统计";
        divTitle.appendChild(divName);

        var divClose=document.createElement("div");
        divClose.className='IYXChart_SelectRect_Close_Div';
        ...
        table.className="IYXChart_SelectRect_Table";
        divDom.appendChild(table);

        var tbody=document.createElement("tbody");
        tbody.className="IYXChart_SelectRect_Tbody";
        ...
        for(var i=0;i<this.MaxRowCount;++i)
        {
            ...
            trDom.className='IYXChart_SelectRect_Tr';
            ...
            for(var j=0;j<3;++j)
            {
                ...
                tdDom.className="IYXChart_SelectRect_Td";   //标题+数值
                item.Td=tdDom;
                trDom.appendChild(tdDom);

                var spanDom=document.createElement("span");
                spanDom.className='IYXChart_SelectRect_Item_Left_Span';
                ...
                var spanDom=document.createElement("span");
                spanDom.className='IYXChart_SelectRect_Item_Right_Span';
                spanDom.innerText='--';
    ...
    {
        if (!this.DivDialog || !this.TKChart) return;
        if (step==0) return;
    ...
    this.Show=function(x,y)
    {
        ...
        {
            var top=this.TKChart.Frame.ChartBorder.GetTop();
    ...
    this.ReloadResource=function(option)
    {
        ...
        {
            var selectData=this.SelectData;
            this.TKChart.UpdateSelectRect(selectData.Start,selectData.End);
    ...
    this.FormatKLineText=function(showData)
    {
        ...
        var defaultfloatPrecision=GetfloatPrecision(this.TKChart.Symbol);

        if (ChartData.IsMinutePeriod(this.TKChart.Period,true))
        {
        ...
        else if (ChartData.IsSecondPeriod(this.TKChart.Period) || ChartData.IsTickPeriod(this.TKChart.Period))
        {
