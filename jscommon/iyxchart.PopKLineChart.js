...
function JSTooltipKLineChart()
{
    ...
    this.Create=function()
    {
        ...
        divDom.className='IYXChart_Tooltip_KLine_Div';
        divDom.id=this.ID;

        var divChart=document.createElement('div');
        divChart.className='IYXChart_Tooltip_KLine_Chart_Div';
        ...
        //语言跟主图保持一致
        if (this.TKChart) this.KLine.Option.Language=g_JSChartLocalization.GetLanguageName(this.TKChart.LanguageID);
        this.KLine.Option.OnCreatedCallback=(chart)=>{ this.OnCreateTKChart(chart); }
