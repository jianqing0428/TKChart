...
function JSDialogDrawTool()
{
    ...
    [
         { 
            ...
            AryChart:
            [
                { Title: '线段', ClassName: 'tkchart_drawtool icon-draw_line', Type:0, Data:{ ID:"线段" } },
                { Title: '线段信息', ClassName: 'tkchart_drawtool icon-infoline', Type:0, Data:{ ID:"InfoLine" } },
                { Title: '射线', ClassName: 'tkchart_drawtool icon-draw_rays', Type:0, Data:{ ID:"射线" } },
                { Title: "趋势线角度", ClassName:"tkchart_drawtool icon-qushixianjiaodu", Type:0, Data:{ ID:"TrendAngle" }},
                { Title: '标价线', ClassName: 'tkchart_drawtool icon-price_line', Type:0, Data:{ ID:"标价线" } },
                { Title: '垂直线', ClassName: 'tkchart_drawtool icon-vertical_line', Type:0, Data:{ ID:"垂直线" } },
                { Title: '十字线', ClassName: 'tkchart_drawtool icon-tubiao_shizixian', Type:0, Data:{ ID:"十字线" } },
                { Title: '箭头', ClassName: 'tkchart_drawtool icon-bottom-arrow-solid', Type:0, Data:{ ID:"箭头" } },
                { Title: '大箭头', ClassName: 'tkchart_drawtool icon-big_arrow', Type:0, Data:{ ID:"ArrowMarker" } },
                { Title: '趋势线', ClassName: 'tkchart_drawtool icon-draw_trendline', Type:0, Data:{ ID:"趋势线" } },
                { Title: '水平线', ClassName: 'tkchart_drawtool icon-draw_hline', Type:0, Data:{ ID:"水平线" } },
                { Title: '水平射线', ClassName: 'tkchart_drawtool icon-tubiao_shuipingshexian', Type:0, Data:{ ID:"水平射线" } },
                { Title: '涂鸦线段', ClassName: 'tkchart_drawtool icon-draw_line', Type:0, Data:{ ID:"涂鸦线段" } },
                { Title: '阻速线', ClassName: 'tkchart_drawtool icon-draw_resline', Type:0, Data:{ ID:"阻速线" } },
                { Title: '通达信阻速线', ClassName: 'tkchart_drawtool icon-draw_resline', Type:0, Data:{ ID:"阻速线2" } },
                { Title: '江恩角度线', ClassName: 'tkchart_drawtool icon-jiangenjiaoduxian', Type:0, Data:{ ID:"江恩角度线" } },
                { Title: '通达信江恩角度线', ClassName: 'tkchart_drawtool icon-jiangenjiaoduxian', Type:0, Data:{ ID:"江恩角度线2" } },
            ]
        }, 
        {
            Title:"通道",
            AryChart:
            [
                { Title: '平行线', ClassName: 'tkchart_drawtool icon-draw_parallel_lines', Type:0, Data:{ ID:"平行线" } }, 
                { Title: '水平线段', ClassName: 'tkchart_drawtool icon-draw_hlinesegment', Type:0, Data:{ ID:"水平线段" } },
                { Title: '平行射线', ClassName: 'tkchart_drawtool icon-draw_p_rays_lines', Type:0, Data:{ ID:"平行射线" } }, 
                { Title: '平行通道', ClassName: 'tkchart_drawtool icon-draw_parallelchannel',Type:0, Data:{ ID:"平行通道" } },
                { Title: '价格通道线', ClassName: 'tkchart_drawtool icon-draw_pricechannel', Type:0, Data:{ ID:"价格通道线" } },
                { Title: '箱型线', ClassName: 'tkchart_drawtool icon-draw_box', Type:0, Data:{ ID:"箱型线" }  },
                { Title:"不相交通道", ClassName:"tkchart_drawtool icon-buxiangjiaojiao", Type:0, Data:{ ID:"DisjointChannel"} },
                { Title:"平滑顶/底", ClassName:"tkchart_drawtool icon-tubiao_buxiangjiaotongdao", Type:0, Data:{ ID:"FlatTop"}},

                { Title: "波段线", ClassName:'tkchart_drawtool icon-draw_waveband',  Type:0, Data:{ ID:"波段线" }  },
                { Title: "百分比线", ClassName:'tkchart_drawtool icon-PercentageLine',  Type:0, Data:{ ID:"百分比线" }  },
                { Title: "黄金分割", ClassName:'tkchart_drawtool icon-GoldenSection',  Type:0, Data:{ ID:"黄金分割" }  },

                { Title: "线形回归线", ClassName:'tkchart_drawtool icon-linear_3',  Type:0, Data:{ ID:"线形回归线" }  },
                { Title: "线形回归带", ClassName:'tkchart_drawtool icon-linear_1',  Type:0, Data:{ ID:"线形回归带" }  },
                { Title: "延长线形回归带", ClassName:'tkchart_drawtool icon-linear_2',  Type:0, Data:{ ID:"延长线形回归带" }  },

                { Title: "Long Position", ClassName:'tkchart_drawtool icon-chart-long-position',  Type:0, Data:{ ID:"TVLongPosition" }  },
                { Title: "Short Position", ClassName:'tkchart_drawtool icon-chart-short-position',  Type:0, Data:{ ID:"TVShortPosition" }  },
            ]
        },
        { 
            Title:"形状",
            AryChart:
            [
                { Title: '圆弧线', ClassName: 'tkchart_drawtool icon-draw_arc', Type:0, Data:{ ID:"圆弧线" }  },
                { Title: '矩形', ClassName: 'tkchart_drawtool icon-rectangle', Type:0, Data:{ ID:"矩形" } },
                { Title: '平行四边形', ClassName: 'tkchart_drawtool icon-draw_quadrangle', Type:0, Data:{ ID:"平行四边形" }  },
                { Title: '三角形', ClassName: 'tkchart_drawtool icon-draw_triangle', Type:0, Data:{ ID:"三角形" }  },
                { Title: '圆', ClassName: 'tkchart_drawtool icon-draw_circle', Type:0, Data:{ ID:"圆" }  },
                { Title: '对称角度', ClassName: 'tkchart_drawtool icon-draw_symangle', Type:0, Data:{ ID:"对称角度" }  },
            ]
        },
        {
            Title:"波浪线",
            AryChart:
            [
                { Title: 'M头W底', ClassName: 'tkchart_drawtool icon-draw_wavemw', Type:0, Data:{ ID:"M头W底" } },
                { Title: '头肩型', ClassName: 'tkchart_drawtool icon-draw_head_shoulders_bt', Type:0, Data:{ ID:"头肩型" } },
                { Title: '波浪尺', ClassName: 'tkchart_drawtool icon-waveruler', Type:0, Data:{ ID:"波浪尺" } },
                { Title: 'AB波浪尺', ClassName: 'tkchart_drawtool icon-waveruler', Type:0, Data:{ ID:"AB波浪尺" } },
        ...
        },
        {
            ...
            AryChart:
            [
                { Title: '斐波那契周期线', ClassName: 'tkchart_drawtool icon-feibonaqizhouqixian', Type:0, Data:{ ID:"斐波那契周期线" } },
                { Title: '斐波那契楔形', ClassName: 'tkchart_drawtool icon-feibonaqiqixing', Type:0, Data:{ ID:"FibWedge" } },
                { Title: '斐波那契回撤', ClassName: 'tkchart_drawtool icon-feibonaqihuiche', Type:0, Data:{ ID:"FibRetracement" } },
                { Title: '斐波那契速度阻力扇', ClassName: 'tkchart_drawtool icon-feibonaqisuduzulishan', Type:0, Data:{ ID:"FibSpeedResistanceFan" } },
            ]
        },
        {
            Title:"测量工具",
            AryChart:
            [
                { Title: '价格范围', ClassName: 'tkchart_drawtool icon-shijianfanwei', Type:0, Data:{ ID:"PriceRange" }  },
                { Title: '时间范围', ClassName: 'tkchart_drawtool icon-jiagefanwei', Type:0, Data:{ ID:"DateRange" }  },
                { Title: "价格和时间范围", ClassName:"tkchart_drawtool icon-jiagefanwei", Type:0, Data:{ ID:"DatePriceRange" } },
                { Title: "监测线", ClassName:"tkchart_drawtool icon-jiance", Type:0, Data:{ ID:"MonitorLine"} },
                { Title: "固定范围成交量分布图", ClassName:"tkchart_drawtool icon-tubiao_gudingfanweichengjiaoliangfenbutu", Type:0, Data:{ ID:"固定范围成交量分布图"}}
            ]
        },
        {
            Title:"文字",
            AryChart:
            [
                { Title:"文字", ClassName: 'tkchart_drawtool icon-draw_text', Type:0, Data:{ ID:"文本" } },
                { Title:"锚点文字", ClassName: 'tkchart_drawtool icon-maodianwenzi', Type:0, Data:{ ID:"AnchoredText"  } },
                { Title:"注释", ClassName: 'tkchart_drawtool icon-maodian ', Type:0, Data:{ ID:"Note"} },
                { Title: '价格标签', ClassName: 'tkchart_drawtool icon-Tooltip', Type:0, Data:{ ID:"PriceLabel" }  },
                { Title: '价格注释', ClassName: 'tkchart_drawtool icon-tooltiptext', Type:0, Data:{ ID:"PriceNote" }  },
    ...
    this.ToolConfig=
    {
        ...
        AryTool:
        [
            { Title:"选中", ClassName:'tkchart_drawtool icon-arrow', Type:1, Data:{ID:JS_DRAWTOOL_MENU_ID.CMD_SELECTED_ID} },
            { Title:"跨周期", ClassName: 'tkchart_drawtool icon-kuazhouqi', Type:2, Data:{ ID:JS_DRAWTOOL_MENU_ID.CMD_CROSS_PERIOD_ID }},
            { Title:'尺子', ClassName: 'tkchart_drawtool icon-ruler', Type:0, Data:{ ID:"尺子" } },
            { Title:"磁铁", ClassName:'tkchart_drawtool icon-xifu', Type:2, Data:{ID:JS_DRAWTOOL_MENU_ID.CMD_ENABLE_MAGNET_ID} },
            { Title:"点击切换颜色", ClassName: 'tkchart_drawtool icon-fangkuai', Type:2, Data:{ ID:JS_DRAWTOOL_MENU_ID.CMD_CHANGE_LINE_COLOR_ID }},
            { Title:"擦除画线", ClassName: 'tkchart_drawtool icon-a-xiangpicachuxiangpica', Type:2, Data:{ ID:JS_DRAWTOOL_MENU_ID.CMD_ERASE_DRAW_CHART_ID }},
            { Title:"删除所有画线", ClassName: 'tkchart_drawtool icon-recycle_bin', Type:2, Data:{ ID:JS_DRAWTOOL_MENU_ID.CMD_DELETE_ALL_DRAW_CHART_ID }}
        ]
    };
    ...
    this.Inital=function(tkchart)
    {
       this.LineColor=g_JSChartResource.DrawPicture.LineColor[0];
       this.TKChart=tkchart;
    }

    this.Create=function()
    {
        var divDom=document.createElement("div");
        divDom.className='IYXChart_DrawTool_Dialog_Div';

        var divTitle=document.createElement("div");
        divTitle.className='IYXChart_DrawTool_Title_Div';
        divTitle.innerText="画图工具";
        divTitle.onmousedown=(e)=>{ this.OnMouseDownTitle(e); }

        var divClose=document.createElement("div");
        divClose.className='IYXChart_DrawTool_Close_Div';
        ...
        table.className="IYXChart_DrawTool_Table";
        divDom.appendChild(table);

        var tbody=document.createElement("tbody");
        tbody.className="IYXChart_DrawTool_Tbody";
        ...
        for(var i=0;i<this.AryChartGroup.length;++i)
        {
            ...
            trDom.className='IYXChart_DrawTool_Group_End_Tr';
    ...
    {
        var trDom=document.createElement("tr");
        trDom.className='IYXChart_DrawTool_Group_Tr';
        tbody.appendChild(trDom);

        var tdDom=document.createElement("td");
        tdDom.className="IYXChart_DrawTool_Group_Td";
        ...
        {
            var trDom=document.createElement("tr");
            trDom.className='IYXChart_DrawTool_Tr';
    ...
    {
        var tdDom=document.createElement("td");
        tdDom.className="IYXChart_DrawTool_Td";
        tdDom.title=item.Title;
        trDom.appendChild(tdDom);

        var spanDom=document.createElement("span");
        spanDom.className=item.ClassName;
        spanDom.classList.add("IYXChart_DrawTool_Span");
    ...
    this.OnClickItem=function(e, data)
    {
        ...
        else if (type==0)
        {
            this.ClearAllSelectedChart();
            this.EnableEraseChart(false);
            data.Span.classList.remove("IYXChart_DrawTool_Span");
            data.Span.classList.add("IYXChart_DrawTool_Span_Selected");
    ...
    this.ClearAllSelectedChart=function()
    {
        for(var i=0;i<this.AryDivChart.length;++i)
        {
            ...
            item.Span.classList.remove("IYXChart_DrawTool_Span_Selected");
            item.Span.classList.add("IYXChart_DrawTool_Span");
        }
    }

    this.EnableCrossPeriod=function(data)
    {
        if (!this.TKChart) return;
        if (!this.TKChart.ChartDrawStorage) return;

        this.TKChart.ChartDrawStorage.EnableCrossPeriod=!this.TKChart.ChartDrawStorage.EnableCrossPeriod;
        var enable=this.TKChart.ChartDrawStorage.EnableCrossPeriod;
        ...
        {
            data.Span.classList.remove("IYXChart_DrawTool_Span_Selected");
            data.Span.classList.add("IYXChart_DrawTool_Span");
        }
    }
    ...
    this.CreateToolItem=function(item, trDom)
    {
        ...
        if (item.Type==2 && item.Data.ID==JS_DRAWTOOL_MENU_ID.CMD_CHANGE_LINE_COLOR_ID)   //颜色
        {
            ...
            inputColor.className="IYXChart_DrawTool_Input_Color";
        ...
        {
            if (this.TKChart && this.TKChart.ChartDrawStorage && this.TKChart.ChartDrawStorage.EnableCrossPeriod)
            {
                data.Span.classList.remove("IYXChart_DrawTool_Span");
                data.Span.classList.add("IYXChart_DrawTool_Span_Selected");
            }
    ...
    this.DeleteAllChart=function()
    {
        ...
        this.TKChart.ClearChartDrawPicture();
    }
    ...
    this.SetEraseChartButtonStatus=function(enable)
    {
        for(var i=0;i<this.AryDivChart.length;++i)
        {
            ...
            if (item.Item.Type==2 && item.Item.Data && item.Item.Data.ID==JS_DRAWTOOL_MENU_ID.CMD_ERASE_DRAW_CHART_ID)
            {
                if (enable)
                {
                    if (item.Span.classList.contains("IYXChart_DrawTool_Span"))
                    {
                        item.Span.classList.replace("IYXChart_DrawTool_Span", "IYXChart_DrawTool_Span_Selected");
                    }
                }
                else
                {
                    if (item.Span.classList.contains("IYXChart_DrawTool_Span_Selected"))
                    {
                        item.Span.classList.replace("IYXChart_DrawTool_Span_Selected","IYXChart_DrawTool_Span");
                    }
                }
                break;
            }
    ...
    this.EnableEraseChart=function(enable)
    {
        ...
        if (this.TKChart.EnableEraseChartDrawPicture==enable) return;

        this.TKChart.EnableEraseChartDrawPicture=enable;
    ...
    this.ChangeMagnet=function(data)
    {
        ...
        var enable=true;
        if (this.TKChart.ChartDrawOption.Magnet)
        {
            var item=this.TKChart.ChartDrawOption.Magnet;
            var enable=!item.Enable;
        }

        if (enable) 
        {
            this.TKChart.SetChartDrawOption({ Magnet:{ Enable:enable, Type:0 }});
            data.Span.classList.remove("IYXChart_DrawTool_Span");
            data.Span.classList.add("IYXChart_DrawTool_Span_Selected");
        }
        else 
        {
            this.TKChart.SetChartDrawOption({ Magnet:{ Enable:false }});
            data.Span.classList.remove("IYXChart_DrawTool_Span_Selected");
            data.Span.classList.add("IYXChart_DrawTool_Span");
        }
    }
    ...
    this.CreateDrawPicture=function(data)
    {
        ...
        this.TKChart.CreateChartDrawPicture(name, option, (chart)=>{ this.OnFinishDrawPicture(chart, data); });
    }

    this.ClearCurrnetDrawPicture=function()
    {
        if (this.TKChart) this.TKChart.ClearCurrnetDrawPicture();
    }
    ...
    this.Close=function(e)
    {
        ...
        if (this.TKChart) this.TKChart.RestoreFocus(this.RestoreFocusDelay);
    }
...
function JSDialogModifyDraw()
{
    ...
    this.AryButton=
    [
        { Title:"修改图形颜色", ClassName: 'tkchart_drawtool icon-Vector IYXChart_Draw_Modify_Dialog_Button_Color_Span', Type:2, Data:{ ID:JS_DRAWTOOL_MENU_ID.CMD_CHANGE_LINE_COLOR_ID }},
        { Title:"修改字体颜色", ClassName: 'tkchart_drawtool icon-zitiyanse1 IYXChart_Draw_Modify_Dialog_Button_Color_Span ', Type:2, Data:{ ID:JS_DRAWTOOL_MENU_ID.CMD_CHANGE_FONT_COLOR_ID }},
        { Title:"修改背景颜色", ClassName: 'tkchart_drawtool icon-zitibeijingse IYXChart_Draw_Modify_Dialog_Button_Color_Span', Type:2, Data:{ ID:JS_DRAWTOOL_MENU_ID.CMD_CHANGE_BG_COLOR_ID }},
        { Title:"修改边框颜色", ClassName: 'tkchart_drawtool icon-biankuang IYXChart_Draw_Modify_Dialog_Button_Color_Span', Type:2, Data:{ ID:JS_DRAWTOOL_MENU_ID.CMD_CHANGE_BORDER_COLOR_ID }},
        { Title:"字体放大", ClassName: 'tkchart_drawtool icon-zoomin IYXChart_Draw_Modify_Dialog_Button_Span', Type:2, Data:{ ID:JS_DRAWTOOL_MENU_ID.CMD_ZOOM_FONT_ID }},
        { Title:"字体缩小", ClassName: 'tkchart_drawtool icon-zoomout IYXChart_Draw_Modify_Dialog_Button_Span', Type:2, Data:{ ID:JS_DRAWTOOL_MENU_ID.CMD_ZOOM_OUT_FONT_ID }},
        { Title:"随机生成文字内容", ClassName: 'tkchart_drawtool icon-bianji IYXChart_Draw_Modify_Dialog_Button_Span', Type:2, Data:{ ID:JS_DRAWTOOL_MENU_ID.CMD_MODIFY_TEXT_ID }},
        { Title:"高级设置", ClassName: 'tkchart_drawtool icon-setting IYXChart_Draw_Modify_Dialog_Button_Span', Type:2, Data:{ ID:JS_DRAWTOOL_MENU_ID.CMD_ADVANCED_SETTING_ID }},

        { Title:"上锁", ClassName: 'tkchart_drawtool icon-lock', Type:2, Data:{ ID:JS_DRAWTOOL_MENU_ID.CMD_LOCK_DRAW_CHART_ID }},
        { Title:"删除图形", ClassName: 'tkchart_drawtool icon-recycle_bin IYXChart_Draw_Modify_Dialog_Button_Span', Type:2, Data:{ ID:JS_DRAWTOOL_MENU_ID.CMD_DELETE_DRAW_CHART_ID }},
    ];
    ...
    {
        var divDom=document.createElement("div");
        divDom.className='IYXChart_Draw_Modify_Dialog_Div';

        var drgDiv=document.createElement("div");
        drgDiv.className="IYXChart_Draw_Modify_Dialog_Drag_Div";
        drgDiv.onmousedown=(e)=>{ this.OnMouseDownTitle(e); }
        divDom.appendChild(drgDiv);

        var spanDom=document.createElement("span");
        spanDom.className="tkchart_drawtool icon-tuodong";
        spanDom.classList.add("IYXChart_Draw_Modify_Dialog_Drag_Span");
    ...
    this.CreateButtonItem=function(item, parentDivDom)
    {
        ...
        divItem.className="IYXChart_Draw_Modify_Dialog_Button_Div";

        var spanTooltip=document.createElement("span");
        spanTooltip.className="IYXChart_Draw_Modify_Tooltip";
        spanTooltip.innerText=item.Title;
        divItem.appendChild(spanTooltip);

        var spanDom=document.createElement("span");
        spanDom.className=item.ClassName;
        //spanDom.classList.add("IYXChart_Draw_Modify_Dialog_Button_Span");
    ...
    this.CreateInputColor=function(data)
    {
        var inputColor=document.createElement("input");
        inputColor.setAttribute("type", "color");
        inputColor.className="IYXChart_Draw_Modify_Input_Color";
        data.InputColor=inputColor;
        inputColor.oninput=(e)=>{ this.OnChangeColor(e, data) };
    ...
    this.CreateColorBar=function(data)
    {
        ...
        divColor.className="IYXChart_Draw_Modify_Dialog_Button_ColorBar_Div";
    ...
    {
        if (this.ChartPicture && this.TKChart)
        {
            this.TKChart.ClearChartDrawPicture(this.ChartPicture);
        }
    ...
    this.OnChangeColor=function(e, data)
    {
        if (!this.ChartPicture || !this.TKChart) return;
        ...
        if (data.Item.Data.ID==JS_DRAWTOOL_MENU_ID.CMD_CHANGE_LINE_COLOR_ID)
        {
            ...
            if (this.TKChart.ChartDrawStorage) this.TKChart.ChartDrawStorage.SaveDrawData(this.ChartPicture);   //保存下
    ...
    this.UpdateLockButtonStyle=function()
    {
        ...
        {
            this.LockButton.Span.classList.remove("IYXChart_Draw_Modify_Dialog_Button_Span");
            this.LockButton.Span.classList.add("IYXChart_Draw_Modify_Dialog_Unlock_Button_Span");
        }
        else
        {
            this.LockButton.Span.classList.remove("IYXChart_Draw_Modify_Dialog_Unlock_Button_Span");
            this.LockButton.Span.classList.add("IYXChart_Draw_Modify_Dialog_Button_Span");
        }
    }
